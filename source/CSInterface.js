 ...
 *
 * @return A new :js:class:`Version` object.
 */
...
/**
 * @class VersionBound
 * Defines a boundary for a version range, which associates a :js:class:`Version` object
 * with a flag for whether it is an inclusive or exclusive boundary.
 *
 * @param version   The :js:class:`Version` object.
 * @param inclusive True if this boundary is inclusive, false if it is exclusive.
 *
 * @return A new :js:class:`VersionBound` object.
 */
 ...
 *
 * @param lowerBound The :js:class: :js:class:`VersionBound` object.
 * @param upperBound The :js:class: :js:class:`VersionBound` object, or null for a range with no upper boundary.
 *
 * @return A new :js:class:`VersionRange` object.
 */
 ...
 * @param version A :js:class:`VersionRange` object that defines a range of valid versions.
 *
 * @return A new :js:class:`Runtime` object.
 */
...
* @param windowType          The window type of the main window of this extension.
                 Valid values are defined by :js:class:`CSXSWindowType`.
...
* @param defaultExtensionDataXml The extension data contained in the default :js:class:`ExtensionDispatchInfo` section of the extension manifest.
* @param specialExtensionDataXml The extension data contained in the application-specific :js:class:`ExtensionDispatchInfo` section of the extension manifest.
* @param requiredRuntimeList     An array of :js:class:`Runtime` objects for runtimes required by this extension.
...
*
* @return A new :js:class:`Extension` object.
*/
 ...
 *
 * @return A new :js:class:`CSEvent` object
 */
 ...
 * :js:class:`CSInterface`.getSystemPath() method.
 * @return A new :js:class:`SystemPath` object.
 */
function SystemPath()
{
}
...
/** @deprecated. Use :js:class:`SystemPath`.Extension.  */
 ...
 *
 * @return A new :js:class:`Direction` object.
 */
 ...
 * @param rgbColor The color of the gradient at this point, an :js:class:`RGBColor` object.
 *
 ...
 * @param direction     A :js:class:`Direction` object for the direction of the gradient
                (up, down, right, or left).
 * @param numStops          The number of stops in the gradient.
 * @param gradientStopList  An array of :js:class:`GradientStop` objects.
 *
 * @return A new :js:class:`GradientColor` object.
 */
 ...
 * @param color         A :js:class:`RGBColor` or :js:class:`GradientColor` object containing specific color information.
 *
 * @return A new :js:class:`UIColor` object.
 */
...
/**
 * @class AppSkinInfo
 * Stores window-skin properties, such as color and font. All color parameter values are :js:class:`UIColor` objects except that systemHighlightColor is :js:class:`RGBColor` object.
 *
 ...
 * @param appSkinInfo   An :js:class:`AppSkinInfo` object containing the application's default color and font styles.
 *
 * @return A new :js:class:`HostEnvironment` object.
 */
 ...
 *
 * @return A new :js:class:`HostCapabilities` object.
 */
 ...
 *
 * @return A new :js:class:`CSInterface` object
 */
 ...
 *
 *   @return A :js:class:`HostEnvironment` object.
 */
 ...
 *
 * @param pathType The path-type constant defined in :js:class:`SystemPath` ,
 *
 ...
 *          If execution fails, the callback function receives the error message :js:class:`EvalScript_ErrMessage`.
 */
 ...
 * in which the extension is currently running.
 *
 * @return A :js:class:`HostCapabilities` object.
 */
 ...
 *
 * @param event A :js:class:`CSEvent` object.
 */
 ...
 *
 * @return Zero or more :js:class:`Extension` objects.
 */
 ...
 * For example, in this input element, the localized :js:class:`key`.value string is displayed
 * instead of the empty :js:class:`value` string:
 *
 ...
 * See http://www.useragentstring.com/pages/Chrome/ for Chrome :js:class:`navigator`.userAgent values.
 *
