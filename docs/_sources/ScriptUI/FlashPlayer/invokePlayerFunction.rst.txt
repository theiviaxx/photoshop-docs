.. _FlashPlayer.invokePlayerFunction:

================================================
FlashPlayer.invokePlayerFunction
================================================

   any **invokePlayerFunction** (:ref:`String` **name**, any **argument**)
...
+--------------+----------------------------------------------------------------------------------------------------------------------------------------+
| **name**     | The name of a Flash ActionScript function that has been registered with the ExternalInterface object by the currently loaded SWF file. |
+--------------+----------------------------------------------------------------------------------------------------------------------------------------+
