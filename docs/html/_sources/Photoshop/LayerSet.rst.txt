...
+-----------------------------------------------------------+----------------------------------------------------------------------------------------+
| :ref:`enabledChannels<LayerSet.enabledChannels>` readonly | The channels that are enabled for the layer set. Must be a list of component channels. |
+-----------------------------------------------------------+----------------------------------------------------------------------------------------+
...
+---------------------------------------+-----------------------+
| :ref:`add<LayerSet.add>` readonly     | Adds an element.      |
+---------------------------------------+-----------------------+
| :ref:`merge<LayerSet.merge>` readonly | Merges the layer set. |
+---------------------------------------+-----------------------+
