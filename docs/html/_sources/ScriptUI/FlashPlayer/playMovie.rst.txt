.. _FlashPlayer.playMovie:

================================================
FlashPlayer.playMovie
================================================

   void **playMovie** (:ref:`Boolean` **rewind**)
...
+------------+-----------------------------------------------------------------------------------------------------------------+
| **rewind** | When true, restarts the movie from the beginning; otherwise, starts playing from thepoint where it was stopped. |
+------------+-----------------------------------------------------------------------------------------------------------------+
